                ...
                <Card className="h-full border-2 hover:border-violet-500/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 bg-gradient-to-br from-violet-50/50 via-white to-purple-50/50">
                  <CardContent className="p-6 text-center">
                    <div className="flex justify-center mb-4">
                      <div className="p-4 rounded-full bg-gradient-violet-subtle group-hover:bg-gradient-violet transition-all">
                        <PackagePlus className="w-8 h-8 text-violet-600 group-hover:scale-110 transition-transform" />
                      </div>
                    </div>
                    <h3 className="text-xl font-bold text-gray-800 group-hover:text-gradient-violet transition-colors mb-2">
                      Business Shipment
                    </h3>
              ...
              <Link href="/faqs" className="group w-full max-w-sm">
                <Card className="h-full border-2 hover:border-violet-500/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 bg-gradient-to-br from-violet-50/50 via-white to-purple-50/50">
                  <CardContent className="p-6 text-center">
                    <div className="flex justify-center mb-4">
                      <div className="p-4 rounded-full bg-gradient-violet-subtle group-hover:bg-gradient-violet transition-all">
                        <HelpCircle className="w-8 h-8 text-violet-600 group-hover:scale-110 transition-transform" />
                      </div>
                    </div>
                    <h3 className="text-xl font-bold text-gray-800 group-hover:text-gradient-violet transition-colors mb-2">
                      FAQs
                    ...
                    <div className="grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
                      <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                          <div className="flex items-start gap-4 p-4 rounded-lg bg-gradient-to-r from-violet-50 to-purple-50 hover:from-violet-100 hover:to-purple-100 transition-colors">
                          ...
                          <div className="flex items-start gap-4 p-4 rounded-lg bg-gradient-to-r from-violet-50 to-purple-50 hover:from-violet-100 hover:to-purple-100 transition-colors">
                            <Mail className="w-6 h-6 text-violet-600 mt-1 flex-shrink-0" />
                            <div>
                              <p className="font-semibold mb-1">Email</p>
                              <a href="mailto:customercare@nge.ae" className="text-muted-foreground hover:text-violet-600 transition-colors">
                                customercare@nge.ae
                              </a>
                            </div>
                          </div>
                          <div className="flex items-start gap-4 p-4 rounded-lg bg-gradient-to-r from-violet-50 to-purple-50 hover:from-violet-100 hover:to-purple-100 transition-colors">
                            <Phone className="w-6 h-6 text-violet-600 mt-1 flex-shrink-0" />
                            <div>
                              <p className="font-semibold mb-1">Mobile</p>
                              <a href="tel:+971501234567" className="text-muted-foreground hover:text-violet-600 transition-colors">
                                +971 50 123 4567
                              </a>
                            </div>
                          </div>
                      ...
                      <div className="rounded-lg overflow-hidden shadow-lg border-2 border-violet-300/30">
                        <iframe 
                ...
                <Card className="bg-white/90 backdrop-blur-sm border-2 shadow-xl">
                  <CardContent className="p-8">
                    <div className="grid md:grid-cols-2 gap-8">
                      <div className="space-y-6">
                        <div>
                          <h3 className="text-3xl font-bold mb-2 bg-gradient-to-r from-violet-600 to-purple-600 bg-clip-text text-transparent">MANILA HUB</h3>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex items-start gap-4 p-4 rounded-lg bg-gradient-to-r from-violet-50 to-purple-50 hover:from-violet-100 hover:to-purple-100 transition-colors">
                            ...
                            <div>
                              <p className="font-semibold mb-1">Email</p>
                              <a href="mailto:customercare.ph@nge.com" className="text-muted-foreground hover:text-violet-600 transition-colors">
                          ...
                          <div className="flex items-start gap-4 p-4 rounded-lg bg-gradient-to-r from-violet-50 to-purple-50 hover:from-violet-100 hover:to-purple-100 transition-colors">
                            ...
                            <div>
                              <p className="font-semibold mb-1">Mobile</p>
                              <a href="tel:+639171234567" className="text-muted-foreground hover:text-violet-600 transition-colors">
                                +63 917 123 4567
                              </a>
                            </div>
                          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16 animate-fade-in">
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                Why Choose <span className="bg-gradient-to-r from-violet-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">Us</span>
              </h2>
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
